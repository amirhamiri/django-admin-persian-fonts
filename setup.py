...
exec(open("admin_persian/version.py").read())

github_url = "https://github.com/amirhamiri"
package_name = "django-admin-persian-fonts"
...
setup(
    ...
    version=__version__,
    description="django-admin-persian-fonts is a Django app for fast and easy use of Persian fonts in the Django admin panel.",
